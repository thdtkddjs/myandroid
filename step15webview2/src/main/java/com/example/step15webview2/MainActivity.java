...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        그렇게 하기 위해 AndroidManifest.xml문서에 외부 저장 장치를
        사용하겠다는 퍼미션이 있어야한다.

        android에서 외부 저장장치는 sd card 라고 부르기도 한다.
        sd card는 따로 install할 필요 없이 기본을 그대로 쓰면된다.
        ...
        moveBtn.setOnClickListener(view->{
            String a = inputUrl.getText().toString();
            webView.loadUrl(a);
        });
